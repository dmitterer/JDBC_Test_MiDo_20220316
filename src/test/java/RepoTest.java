...
public class RepoTest {
    ...
    @Test
    public void testZugangsdatenEinfuegen() {
        Random r = new Random();
    ...
    @Test
    public void testNeueZugangsdatenSpeichernUndDannHolenMitId() {
        Random r = new Random();
        int zufall = r.nextInt(100);
        Optional<Zugangsdaten> optEingefuegt = repo.insert(new Zugangsdaten(null, "username" + zufall, "asdfjklö", "http://www.google.at"));
        Assertions.assertTrue(optEingefuegt.isPresent());
    ...
    @Test
    public void testAlleDatensaetzeHolen() {
    ...
    @Test
    public void testAlleDatensaetzeMitUrlTeilHolen() {
